package io.jenkins.plugins.jenkins_plugin;
import java.util.*;
/**
...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:jenkins-plugin:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","/home/alayne/repos/projects/jenkins-plugin");
    parameters.put("artifactId","jenkins-plugin");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","/home/alayne/repos/projects/jenkins-plugin/target/classes");
    parameters.put("testOutputDirectory","/home/alayne/repos/projects/jenkins-plugin/target/test-classes");
